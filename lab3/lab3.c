...
int date(char *input)
{
    ...
    temp[0] = input[c]; temp[1] = input[c+1]; temp[2] = input[c+2];
                ...
                if (temp == "May")
                {
                    t1 = t1 + (31 + 28 + 31 + 30)*3600;
                }
                if (temp == "Jun")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31)*3600;
                }
                if (temp == "Jul")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31 + 30)*3600;
                }
                if (temp == "Aug")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31 + 30 + 31)*3600;
                }
                if (temp == "Sep")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31 + 30 + 31 + 31)*3600;
                }
                if (temp == "Oct")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + 30)*3600;
                }
                if (temp == "Nov")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + 30 + 31)*3600;
                }
                if (temp == "Dec")
                {
                    t1 = t1 + (31 + 28 + 31 + 30 + 31 + 30 + 31 + 31 + 30 + 31 + 30)*3600;
                }
