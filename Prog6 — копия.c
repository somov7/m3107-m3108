...
{
    FILE*fout = fopen("/Users/siriusa/Desktop/ITMO_Practic/Test.txt","wb");
...
Compress(Archive,"T/Users/siriusa/Desktop/ITMO_Practic/Test.txt");
}
void DecreateArc(char *Archive){
	
	 Decompress(Archive,"/Users/siriusa/Desktop/ITMO_Practic/Test.txt");
     FILE*fin = fopen("/Users/siriusa/Desktop/ITMO_Practic/Test.txt","rb");
     int num = 0;
...
void ListOfArchive(char * Archive)
{
	...
	Compress(Archive,"/Users/siriusa/Desktop/ITMO_Practic/Test.txt");
}
int main( int argc,char **argv){
    char filename[100][100];
    if (memcmp(argv[1],"--file",6)==0 && memcmp(argv[3],"--create",8)==0){
        for(int i = 0;i<argc-4;i++){
            memmove(filename[i],argv[4],strlen(argv[4])+1);
        }
