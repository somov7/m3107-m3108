...
int main(int argc, char *argv[])
{
    ...
    if (Option == -1)
    {
        printf("\nOption doesn't exist. Use that list of available commands:\n-l or --lines to get lines quantity only");
        printf("\n-c or --bytes to get size of file in bytes");
        printf("\n-w or --words to get the quantity of words\n");
        return -1;
    }
